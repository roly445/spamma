...
{
    public async ValueTask<QueryResult<SearchSubdomainModeratorsQueryResult>> Handle(SearchSubdomainModeratorsQuery request, CancellationToken cancellationToken)
    {
