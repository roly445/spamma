...
internal class GetDetailedSubdomainByIdQueryAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<GetDetailedSubdomainByIdQuery>
{
    public async Task<AuthorizationResult> Authorize(GetDetailedSubdomainByIdQuery request, CancellationToken cancellationToken)
    {
