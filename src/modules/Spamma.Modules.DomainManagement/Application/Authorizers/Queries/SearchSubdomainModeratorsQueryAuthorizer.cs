...
internal class SearchSubdomainModeratorsQueryAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<SearchSubdomainModeratorsQuery>
{
    public async Task<AuthorizationResult> Authorize(SearchSubdomainModeratorsQuery request, CancellationToken cancellationToken)
    {
