...
internal class GetDetailedDomainByIdQueryAuthorizer(IHttpContextAccessor httpContextAccessor) : IBluQubeAuthorizer<GetDetailedDomainByIdQuery>
{
    public Task<AuthorizationResult> Authorize(GetDetailedDomainByIdQuery request, CancellationToken cancellationToken)
    {
