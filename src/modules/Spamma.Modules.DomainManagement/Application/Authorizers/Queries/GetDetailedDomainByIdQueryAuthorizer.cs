...
internal class GetDetailedDomainByIdQueryAuthorizer : AbstractRequestAuthorizer<GetDetailedDomainByIdQuery>
{
    public override void BuildPolicy(GetDetailedDomainByIdQuery request)
    {
