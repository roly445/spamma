...
internal class RemoveModeratorFromDomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor) : IBluQubeAuthorizer<RemoveModeratorFromDomainCommand>
{
    public Task<AuthorizationResult> Authorize(RemoveModeratorFromDomainCommand request, CancellationToken cancellationToken)
    {
