...
internal class SuspendDomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor) : IBluQubeAuthorizer<SuspendDomainCommand>
{
    public Task<AuthorizationResult> Authorize(SuspendDomainCommand request, CancellationToken cancellationToken)
    {
