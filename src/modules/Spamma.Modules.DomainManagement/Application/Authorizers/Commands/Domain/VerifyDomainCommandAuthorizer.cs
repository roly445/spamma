...
internal class VerifyDomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor) : IBluQubeAuthorizer<VerifyDomainCommand>
{
    public Task<AuthorizationResult> Authorize(VerifyDomainCommand request, CancellationToken cancellationToken)
    {
