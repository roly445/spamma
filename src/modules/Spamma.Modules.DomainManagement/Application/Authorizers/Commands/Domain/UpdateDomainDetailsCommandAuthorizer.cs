...
internal class UpdateDomainDetailsCommandAuthorizer(IHttpContextAccessor httpContextAccessor) : IBluQubeAuthorizer<UpdateDomainDetailsCommand>
{
    public Task<AuthorizationResult> Authorize(UpdateDomainDetailsCommand request, CancellationToken cancellationToken)
    {
