...
internal class DisableChaosAddressCommandAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<DisableChaosAddressCommand>
{
    public async Task<AuthorizationResult> Authorize(DisableChaosAddressCommand request, CancellationToken cancellationToken)
    {
