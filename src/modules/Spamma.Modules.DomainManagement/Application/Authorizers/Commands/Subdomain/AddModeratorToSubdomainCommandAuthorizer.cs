...
internal class AddModeratorToSubdomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<AddModeratorToSubdomainCommand>
{
    public async Task<AuthorizationResult> Authorize(AddModeratorToSubdomainCommand request, CancellationToken cancellationToken)
    {
