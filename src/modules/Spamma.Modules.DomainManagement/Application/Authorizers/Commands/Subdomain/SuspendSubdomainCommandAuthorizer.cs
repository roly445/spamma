...
internal class SuspendSubdomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<SuspendSubdomainCommand>
{
    public async Task<AuthorizationResult> Authorize(SuspendSubdomainCommand request, CancellationToken cancellationToken)
    {
