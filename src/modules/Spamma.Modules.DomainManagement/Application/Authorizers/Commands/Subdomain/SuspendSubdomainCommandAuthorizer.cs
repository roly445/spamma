...
internal class SuspendSubdomainCommandAuthorizer : AbstractRequestAuthorizer<SuspendSubdomainCommand>
{
    public override void BuildPolicy(SuspendSubdomainCommand request)
    {
