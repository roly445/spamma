...
internal class AddViewerToSubdomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<AddViewerToSubdomainCommand>
{
    public async Task<AuthorizationResult> Authorize(AddViewerToSubdomainCommand request, CancellationToken cancellationToken)
    {
