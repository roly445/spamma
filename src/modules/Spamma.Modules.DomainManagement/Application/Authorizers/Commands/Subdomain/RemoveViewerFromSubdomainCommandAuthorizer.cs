...
internal class RemoveViewerFromSubdomainCommandAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<RemoveViewerFromSubdomainCommand>
{
    public async Task<AuthorizationResult> Authorize(RemoveViewerFromSubdomainCommand request, CancellationToken cancellationToken)
    {
