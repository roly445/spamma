...
internal class GetEmailByIdQueryAuthorizer(IHttpContextAccessor httpContextAccessor, IDocumentSession documentSession) : IBluQubeAuthorizer<GetEmailByIdQuery>
{
    public async Task<AuthorizationResult> Authorize(GetEmailByIdQuery request, CancellationToken cancellationToken)
    {
