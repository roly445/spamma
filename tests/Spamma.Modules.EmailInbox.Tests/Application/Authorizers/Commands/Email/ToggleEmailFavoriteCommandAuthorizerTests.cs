...
public class ToggleEmailFavoriteCommandAuthorizerTests
{
    ...
    public void BuildPolicy_WorksWithDifferentEmailIds()
    {
        ...
        var authorizer1 = new ToggleEmailFavoriteCommandAuthorizer();
        var authorizer2 = new ToggleEmailFavoriteCommandAuthorizer();

        // Act
        authorizer1.BuildPolicy(new ToggleEmailFavoriteCommand(emailId1));
        authorizer2.BuildPolicy(new ToggleEmailFavoriteCommand(emailId2));
