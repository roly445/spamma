...
public class AddViewerToSubdomainCommandHandlerTests
{
    ...
    [Fact]
    public async Task Handle_WhenSubdomainFound_AddViewerAndPublishesEvent()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_AddingMultipleViewers_PublishesMultipleEvents()
    {
        // Arrange
        var subdomainId = Guid.NewGuid();
        var domainId = Guid.NewGuid();
