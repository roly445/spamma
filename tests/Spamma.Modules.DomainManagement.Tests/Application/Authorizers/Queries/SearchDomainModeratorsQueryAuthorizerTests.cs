...
/// <summary>
/// Tests for SearchDomainModeratorsQueryAuthorizer to verify authorization requirements.
/// </summary>
public class SearchDomainModeratorsQueryAuthorizerTests
{
    [Fact]
    public void BuildPolicy_AddsAuthenticationRequirement()
    {
        // Arrange
        var query = new SearchDomainModeratorsQuery(Guid.NewGuid());
        var authorizer = new SearchDomainModeratorsQueryAuthorizer();
    ...
    public void BuildPolicy_WorksWithDifferentDomainIds()
    {
        ...
        var authorizer1 = new SearchDomainModeratorsQueryAuthorizer();
        var authorizer2 = new SearchDomainModeratorsQueryAuthorizer();

        // Act
        authorizer1.BuildPolicy(new SearchDomainModeratorsQuery(domainId1));
        authorizer2.BuildPolicy(new SearchDomainModeratorsQuery(domainId2));
