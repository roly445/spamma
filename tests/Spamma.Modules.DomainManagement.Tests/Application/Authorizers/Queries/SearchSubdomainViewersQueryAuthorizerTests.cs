...
public class SearchSubdomainViewersQueryAuthorizerTests
{
    ...
    {
        // Arrange
        var query = new SearchSubdomainViewersQuery(Guid.NewGuid());
        var authorizer = new SearchSubdomainViewersQueryAuthorizer();
    ...
    public void BuildPolicy_WorksWithDifferentSubdomainIds()
    {
        ...
        var authorizer1 = new SearchSubdomainViewersQueryAuthorizer();
        var authorizer2 = new SearchSubdomainViewersQueryAuthorizer();

        // Act
        authorizer1.BuildPolicy(new SearchSubdomainViewersQuery(subdomainId1));
        authorizer2.BuildPolicy(new SearchSubdomainViewersQuery(subdomainId2));
