...
public class RemoveViewerFromSubdomainCommandAuthorizerTests
{
    [Fact]
    public void BuildPolicy_AddsAuthenticationRequirement()
    {
        // Arrange
        var authorizer = new RemoveViewerFromSubdomainCommandAuthorizer();
    ...
    public void BuildPolicy_WorksWithDifferentSubdomainIds()
    {
        ...
        var userId = Guid.NewGuid();
        var authorizer1 = new RemoveViewerFromSubdomainCommandAuthorizer();
        var authorizer2 = new RemoveViewerFromSubdomainCommandAuthorizer();
        var command1 = new RemoveViewerFromSubdomainCommand(subdomainId1, userId);
        var command2 = new RemoveViewerFromSubdomainCommand(subdomainId2, userId);
