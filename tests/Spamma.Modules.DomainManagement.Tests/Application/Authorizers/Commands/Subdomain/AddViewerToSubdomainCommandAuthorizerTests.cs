...
public class AddViewerToSubdomainCommandAuthorizerTests
{
    [Fact]
    public void BuildPolicy_AddsAuthenticationRequirement()
    {
        // Arrange
        var authorizer = new AddViewerToSubdomainCommandAuthorizer();
    ...
    public void BuildPolicy_WorksWithDifferentSubdomainIds()
    {
        ...
        var userId = Guid.NewGuid();
        var authorizer1 = new AddViewerToSubdomainCommandAuthorizer();
        var authorizer2 = new AddViewerToSubdomainCommandAuthorizer();
        var command1 = new AddViewerToSubdomainCommand(subdomainId1, userId);
        var command2 = new AddViewerToSubdomainCommand(subdomainId2, userId);
