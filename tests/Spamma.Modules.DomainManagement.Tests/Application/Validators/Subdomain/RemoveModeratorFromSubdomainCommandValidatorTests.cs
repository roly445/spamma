...
public class RemoveModeratorFromSubdomainCommandValidatorTests
{
    [Fact]
    public async Task ValidateAsync_ValidCommand_IsValid()
    {
        // Arrange
        var validator = new RemoveModeratorFromSubdomainCommandValidator();
        var command = new RemoveModeratorFromSubdomainCommand(
