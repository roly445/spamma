...
public class AddViewerToSubdomainCommandValidatorTests
{
    [Fact]
    public async Task ValidateAsync_ValidCommand_IsValid()
    {
        // Arrange
        var validator = new AddViewerToSubdomainCommandValidator();
        var command = new AddViewerToSubdomainCommand(
