...
public class EnableChaosAddressCommandValidatorTests
{
    [Fact]
    public async Task ValidateAsync_ValidCommand_IsValid()
    {
        // Arrange
        var validator = new EnableChaosAddressCommandValidator();
        var command = new EnableChaosAddressCommand(ChaosAddressId: Guid.NewGuid());
    ...
    public async Task ValidateAsync_EmptyChaosAddressId_HasValidationError()
    {
        // Arrange
        var validator = new EnableChaosAddressCommandValidator();
        var command = new EnableChaosAddressCommand(ChaosAddressId: Guid.Empty);
