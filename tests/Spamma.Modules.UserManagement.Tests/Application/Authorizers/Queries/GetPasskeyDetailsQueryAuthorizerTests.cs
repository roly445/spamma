...
public class GetPasskeyDetailsQueryAuthorizerTests
{
    ...
    {
        // Arrange
        var authorizer = new GetPasskeyDetailsQueryAuthorizer();
        var passkeyId = Guid.NewGuid();
        var query = new GetPasskeyDetailsQuery(passkeyId);
    ...
    {
        // Arrange
        var authorizer1 = new GetPasskeyDetailsQueryAuthorizer();
        var authorizer2 = new GetPasskeyDetailsQueryAuthorizer();
        var passkeyId1 = Guid.NewGuid();
        var passkeyId2 = Guid.NewGuid();
        var query1 = new GetPasskeyDetailsQuery(passkeyId1);
        var query2 = new GetPasskeyDetailsQuery(passkeyId2);
